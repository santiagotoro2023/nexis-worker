...
val NxBg2       = Color(0xFF0D0D0A)  // --bg2  (sidebar/surface)
val NxBg3       = Color(0xFF131310)  // --bg3  (card surface)
val NxDim       = Color(0xFF2A2A1A)  // --dim  (hover/pressed)
val NxFg        = Color(0xFFC4B898)  // --fg
val NxFg2       = Color(0xFF887766)  // --fg2
val NxBorder    = Color(0xFF1A1A12)  // --border
val NxOutline   = Color(0xFF3A3A28)  // interactive outlines
val NxGreen     = Color(0xFF4CAF50)  // online status
val NxRed       = Color(0xFFEF5350)  // error / offline
val NxYellow    = Color(0xFFFFC107)  // warning
